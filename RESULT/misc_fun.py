...
flags.DEFINE_string('DEFAULT_IN', 'E:/Aritificial Intellgence for Mechatronics/Assignment1/dataset/', 'Default input folder.')
flags.DEFINE_string('DEFAULT_OUT', 'E:/Aritificial Intellgence for Mechatronics/Assignment1/results/', 'Default output folder.')
flags.DEFINE_string(
    'DEFAULT_DOWNLOAD', 'E:/Aritificial Intellgence for Mechatronics/Assignment1/dataset/',
