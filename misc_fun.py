...
flags.DEFINE_string('DEFAULT_IN', 'E:/Artificial_Intelligence_for_Mechatronics/Assignment1/dataset/', 'Default input folder.')
flags.DEFINE_string('DEFAULT_OUT', 'E:/Artificial_Intelligence_for_Mechatronics/Assignment1/results/', 'Default output folder.')
flags.DEFINE_string(
    'DEFAULT_DOWNLOAD', 'E:/Artificial_Intelligence_for_Mechatronics/Assignment1/dataset/',
